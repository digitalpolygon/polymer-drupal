...
INCLUDE;
     ...
     */
    protected function createDynamicSiteSettingsFile(string $site): void
    {
...
/**
 * @file
 * This file is generated by polymer-drupal.
 */

INCLUDE;

        foreach ($siteSettingsFiles as $id => $settingsInclusionText) {
            $settingsIncludeText .= "\n" . $settingsInclusionText . "\n\n";
        }
        file_put_contents($settingsFilePath, $settingsIncludeText);
    }
